...
Page({
  ...
  onShareAppMessage: function() {
    console.log('分享');
    return {
      title: this.data.cargoItem.cargoName,
      imageUrl: this.data.imgBaseUrl + this.data.cargoItem.imgArr[0],
      path: '/pages/detail/detail?cargoItem=' + JSON.stringify(this.data.cargoItem)
    }
  }
})